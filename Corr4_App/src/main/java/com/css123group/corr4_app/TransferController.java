...
import javafx.scene.input.KeyCode; // Required JavaFX Input module
import javafx.scene.input.KeyEvent;  // Required JavaFX Input module

// NOTE: Alerts is in the same package, so it is accessible without an explicit import.
